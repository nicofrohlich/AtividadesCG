...
// Enum para definir os movimentos da câmera
...
// Constantes padrão para a câmera
...
public:
    ...
    // Retorna a matriz de visão calculada com base nos vetores da câmera
    ...
    void ProcessMouseMovement(float xoffset, float yoffset, bool constrainPitch = true) {
        ...
        // Atualiza os vetores da câmera com base nos novos ângulos
        updateCameraVectors();
    }
...
private:
    // Atualiza os vetores da câmera com base nos ângulos Yaw e Pitch
