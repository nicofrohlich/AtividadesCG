...
glm::vec3 cameraFront = glm::vec3(0.0f, 0.0f, -1.0f); // Vetor direção da câmera
glm::vec3 cameraUp = glm::vec3(0.0f, 1.0f, 0.0f);    // Vetor para cima
float fov = 45.0f;                                   // Field of View para o zoom
float yaw = -90.0f;                                  // Rotação horizontal
float pitch = 0.0f;                                  // Rotação vertical
bool firstMouse = true;
float lastX = WIDTH / 2.0f, lastY = HEIGHT / 2.0f;   // Posição inicial do mouse
